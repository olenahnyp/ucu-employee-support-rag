"""
This file uses Google Gemma (free) model to texualize pictures. 
In this code I added time sleep because the model is free, therefore 
server may be overloaded with prompts from time to time.
"""
import os
import io
import base64
    ...
    with open(output_file, "a", encoding="utf-8") as f:
        for index, img_file in enumerate(current_folder_photos):
            ...
            for attempt in range(MAX_RETRIES):
                ...
                print(f"Skip file {img_file} after {MAX_RETRIES} tries")
